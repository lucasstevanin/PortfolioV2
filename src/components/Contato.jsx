        ...
        >
          <div className="flex flex-col items-center p-5 bg-[#111111] rounded-lg justify-evenly">
            <div className="flex flex-col items-center">
              <h1 className="text-[#803cff] text-[4.5vw] md:text-[2.5vw] lg:text-[1.2rem] font-Aquatico font-bold tracking-wider uppercase">
                Email:
              </h1>
              <a
                href="#"
                className="font-Aquatico text-white text-[4.5vw] md:text-[2.5vw] lg:text-[1.2rem] underline tracking-wider"
              >
            ...
            >
              ...
              <span className="text-[3.5vw] md:text-[2vw] lg:text-[1.2rem] font-bold tracking-wider text-white uppercase font-Aquatico">
